...
export default function RegisterPage() {
  ...
  return (
    <PageContainer gradient="from-green-50 via-white to-emerald-50">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-green-100 p-8">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none text-base transition-all"
            ...
            <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-3 bg-white/80 backdrop-blur-sm text-gray-500 font-medium">Hoặc đăng ký với</span>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button
                ...
                disabled={loading}
                className="flex items-center justify-center px-4 py-3 border-2 border-gray-200 rounded-lg hover:bg-gray-50 hover:border-green-200 transition-all disabled:opacity-50 disabled:cursor-not-allowed font-medium"
              >
